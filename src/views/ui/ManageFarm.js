import { Row, Col, Card, CardTitle, CardBody, FormGroup ,Label ,Input, Button, Form, Alert} from "reactstrap";
              ...
              <Col sm="12" md={{offset: 2,size: 8}}>
                <div className={contentArea}>
                    <div className='gridmargin'>
                        <FormGroup>
                            <Label for="exampleSelect">Farm Name</Label>
                            <Input id="exampleSelect" name="select" type="select" onChange={displayForm}>
                              <option selected>Select Farm</option>
                              <option>Sachin Farm</option>
                              <option>Aayush Farm</option>
                            </Input>
                        </FormGroup>
                        {
                          showForm &&
                          <Form>
                              <Alert color="secondary">Form Detail</Alert>
                              <FormGroup>
