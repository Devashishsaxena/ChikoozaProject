                                        ...
                                        <Form onSubmit={save}>
                                            ...
                                            }
                                            {
                                                        ...
                                                        <Accordion.Body style={{ backgroundColor: 'white' }}>
                                                            <Row>
                                                                ...
                                                                <Col>
                                                                    ...
                                                                    <Input value='0' onChange={showInputs} id="selectAction" name="selectAction" type="select">
                                                ...
                                                <div className="d-flex">
                                                   <Button color="secondary" className="btn" type="Update"  >Cancel</Button>
                                                    <Button color="primary" className="btn ml-3" type="Update"  >Save</Button>
                                                </div>
                                                </>
                                            }
                                        </Form>
